...
public class StudentInterface {
	...
	public void RegistrationFrom() {
		try (SessionFactory sf = new Configuration().configure().addAnnotatedClass(StudentRegistration.class)
				.addAnnotatedClass(Admin.class).buildSessionFactory();
			...
			while (true) {
				...
				try {
					...
					System.out.println(
							"Invalid date of birth. Please enter a valid date of birth in the format dd/MM/yyyy.");
				}
			}
			...
			while (true) {
				...
				if (matcher.matches()) {
					...
					System.out.println(
							"Invalid Indian Aadhar card number. Please enter a 12-digit numeric Aadhar number.");
				}
	...
	public void ApplicationStatus() {
		try (SessionFactory sf = new Configuration().configure().addAnnotatedClass(StudentRegistration.class)
			...
			if (stdRegForm != null && admin != null) {
				...
				System.out.println("Course Allocation is not Started.");
			}
		} catch (Exception ex) {
